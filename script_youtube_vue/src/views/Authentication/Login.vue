    ...
    <div class="inner_login_page">
      <div class="container m-auto">
        <div class="flex justify-center align-middle">
          <div class="flex justify-center items-center w-10/12 m-auto h-screen border_text">
            <div class="wrapper_text_login flex-1 flex justify-center items-center">
              <div class="inner">
                <div class="title text-8xl text-red-500 font-bold">Youtube</div>
                <div class="subtitle text-4xl">
                  Youtube helps you connect and share <br />
                  ...
                  <template #footer>
                    <div class="row">
                      ...
                      <div class="mt-3">
                        <button
                          type="submit"
                          class="d_block_important mt-5 mb-3 mx-auto w_100 bg-red-500 py-3 px-5 rounded text-white"
