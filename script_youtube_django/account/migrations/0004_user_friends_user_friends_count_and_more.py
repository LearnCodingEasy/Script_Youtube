# Generated by Django 5.1.1 on 2024-11-02 03:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0003_user_script_count'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('sent', 'Sent'), ('not sent', 'Not Sent'), ('accepted', 'Accepted'), ('Waiting', 'Waiting'), ('rejected', 'Rejected')], default='not sent', max_length=20)),
